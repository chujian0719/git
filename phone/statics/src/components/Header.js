    ...
    render: function() {
        ...
        return (
            <header className="header">
                ...
                {
                    type != 'address_operate' && type != 'address_list' && type != 'detail' && type != 'cart' && type != 'tool' && type != 'clearing' ?
                    <div className="common_box">
                        <div className="code fl">
                            {type == 'goods_list' ? <span onClick={this.props.pageUp} className="icon_common icon-arrow_left"></span> : '月亮'}
                        </div>
